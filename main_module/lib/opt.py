...
- :``TSP``: Traveling salesman problem: Solve the Traveling salesman problem
    using integer programming/nearest neighbour algorithm.
- :``Transport``: Transportation problem: Solve the  Transportation problem
...
class TSP:
    ...
    def __init__(self):
        """Initialize variables for module ``TSP``."""
