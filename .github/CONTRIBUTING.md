...
- Create a new branch from `testing` and name it according to the ticket type and number. Example: `feature_58` or `bug_59`.
- Ensure to follow [SemVer](https://semver.org/) for versioning.
- Ensure the [directory structure](../doc/Directory_structure.md) is followed.
...
rating of atleast 8/10.
- Ensure to profile your modules and move any bottlenecks to a low lantency system/module.
- Ensure to add unit tests with corner cases.
